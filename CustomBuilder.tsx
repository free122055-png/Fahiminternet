...
import { DataPack, Operator } from '../types';
...
export default function CustomBuilder({ onOrderCustomPack }: CustomBuilderProps) {
  // Config state
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 md:p-8">
        ...
        <div className="lg:col-span-7 space-y-6">
              ...
              {(['GP', 'Robi', 'Airtel', 'Banglalink', 'Teletalk'] as const).map((op) => {
                ...
                return (
                  <button
                    ...
                    className={`py-3 rounded-xl text-xs font-black border uppercase tracking-wider transition-all cursor-pointer ${
                      isSelected 
          ...
          <div className="space-y-3 bg-slate-50/50 border border-slate-150 p-4 rounded-2xl">
            <div className="flex justify-between items-center text-xs font-bold">
              ...
              <span className="text-emerald-600 font-black text-sm">{data} GB</span>
            </div>
          ...
          <div className="space-y-3 bg-slate-50/50 border border-slate-150 p-4 rounded-2xl">
            <div className="flex justify-between items-center text-xs font-bold">
              ...
              <span className="text-emerald-600 font-black text-sm">{minutes} Min</span>
            </div>
          ...
          <div className="space-y-3 bg-slate-50/50 border border-slate-150 p-4 rounded-2xl">
            <div className="flex justify-between items-center text-xs font-bold">
              ...
              <span className="text-emerald-600 font-black text-sm">{sms} SMS</span>
            </div>
        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-slate-50 to-slate-100/40 p-6 rounded-3xl border border-slate-200/60 flex flex-col justify-between">
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="space-y-1 bg-emerald-50 border border-emerald-150 p-3.5 rounded-2xl">
            ...
            <button
              ...
              className={`w-full py-4 text-xs font-black text-white rounded-2xl uppercase tracking-wider shadow-lg shadow-emerald-500/10 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer ${

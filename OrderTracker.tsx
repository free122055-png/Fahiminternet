...
import { Search, Loader2, Calendar, ClipboardCheck, Phone, CheckCircle2, Circle, AlertCircle, RefreshCw } from 'lucide-react';
    ...
    <div className="max-w-3xl mx-auto space-y-6">
        ...
        <form onSubmit={handleSearch} className="max-w-lg mx-auto flex gap-2 pt-2">
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-150 rounded-2xl text-xs font-bold focus:bg-white focus:border-emerald-500 focus:outline-none"
            />
          </div>
          <button
            type="submit"
            disabled={searching}
            className="px-6 py-3.5 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl text-xs font-black uppercase tracking-wider flex items-center gap-2 cursor-pointer disabled:opacity-50"
          >
      ...
      <div className="space-y-4">
        {searched && foundOrders.length === 0 && (
          <div className="bg-white rounded-2xl p-8 border border-slate-150 shadow-sm text-center space-y-3">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
                    ...
                    <div className="text-left sm:text-right">
                      ...
                      <strong className="text-lg font-black text-emerald-600 font-mono">৳{order.price}</strong>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-100 text-[10px] font-bold text-slate-500">
